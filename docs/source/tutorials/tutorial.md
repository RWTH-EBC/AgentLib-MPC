...
You can also find a “getting started” guide in the examples in agentlib_mpc, which explain the first steps for creating an MPC:
https://github.com/RWTH-EBC/AgentLib-MPC/tree/main/examples/getting-started
.. toctree::
   :maxdepth: 2
