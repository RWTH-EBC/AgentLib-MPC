        ...
        "modules": [
            {
                ...
                "filter_time_series": "VOL",        # possible values: "ROC", "VOL", "KNN" or None (just remove the line)
                "filter_training_samples": "CaS",   # possible values: "CaS" or None (just remove the line)
            },
