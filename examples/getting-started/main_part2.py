"""
This is part two of the tutorial. In this part we learn about different types of objectives.
...
Remember to run the correct main file (this one) to see the changes in action.
